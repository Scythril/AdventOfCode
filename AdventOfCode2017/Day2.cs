...
namespace AdventOfCode2017
{
    public class Day2
    {
        public int Part1(String input)
        {
            ...
            {
                var numbers = row.Trim().Split(new[] { '\t', ' ' }, StringSplitOptions.RemoveEmptyEntries).ToList().Select(x => Int32.Parse(x));
        ...
        public int Part2(String input)
        {
            ...
            foreach (var row in input.Split(new[] { '\n', '\r' }, StringSplitOptions.RemoveEmptyEntries))
            {
                var numbers = row.Trim().Split(new[] { '\t', ' ' }, StringSplitOptions.RemoveEmptyEntries).ToList().Select(x => Int32.Parse(x)).OrderByDescending(x => x).ToList();
                var found = false;
...
6151    5857    4865    437 6210    237 37  410 544 214 233 6532    2114    207 5643    6852";
            ...
            Console.WriteLine("\n###############\n###############\nDay 2\n###############\n###############\n");
            Console.WriteLine("\n###############\nPart 1\n###############\n");
            Console.WriteLine(day2.Part1(@"5 1 9 5
7 5 3
2 4 6 8"));
            Console.WriteLine(day2.Part1(input));

            Console.WriteLine("\n###############\nPart 2\n###############\n");
            Console.WriteLine(day2.Part2(@"5 9 2 8
9 4 7 3
3 8 6 5"));
