...
jwfm ptjwrbl hhuv uolz adyweh qpj wxyogp igvnojq jmfw pqs fsnirby";
            ...
            Console.WriteLine("\n###############\n###############\nDay 4\n###############\n###############\n");
            Console.WriteLine("\n###############\nPart 1\n###############\n");
            Console.WriteLine(day4.Part1("aa bb cc dd ee"));
            Console.WriteLine(day4.Part1("aa bb cc dd aa"));
            Console.WriteLine(day4.Part1("aa bb cc dd aaa"));
            Console.WriteLine(day4.Part1(input));

            Console.WriteLine("\n###############\nPart 2\n###############\n");
            Console.WriteLine(day4.Part2("abcde fghij"));
            Console.WriteLine(day4.Part2("abcde xyz ecdab"));
            Console.WriteLine(day4.Part2("a ab abc abd abf abj"));
            Console.WriteLine(day4.Part2("iiii oiii ooii oooi oooo"));
            Console.WriteLine(day4.Part2("oiii ioii iioi iiio"));
