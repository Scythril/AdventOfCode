...
namespace AdventOfCode2017
{
    public class Day8
    {
        ...
        {
            var registers = new SortedDictionary<String, int>();
            foreach (var line in input.Split(new[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries))
            {
                ...
                {
                    case ">":
                        condition = registers[tokens[4]] > Int32.Parse(tokens[6]);
                        break;
                    case "<":
                        condition = registers[tokens[4]] < Int32.Parse(tokens[6]);
                        break;
                ...
                {
                    case "inc":
                        registers[tokens[0]] += Int32.Parse(tokens[2]);
                        break;
                    case "dec":
                        registers[tokens[0]] -= Int32.Parse(tokens[2]);
                        break;
        ...
        public int Part2(String input)
        {
            ...
            foreach (var line in input.Split(new[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries))
            {
                ...
                if (registers[tokens[0]] > maxValue)
                    maxValue = registers[tokens[0]];
            }
            return maxValue;
        }
        ...
        public static void Run()
        {
            ...
            Console.WriteLine("\n###############\n###############\nDay 8\n###############\n###############\n");
            Console.WriteLine("\n###############\nPart 1\n###############\n");
            Console.WriteLine(day8.Part1(@"b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10"));
            ...
            Console.WriteLine("\n###############\nPart 2\n###############\n");
            Console.WriteLine(day8.Part2(@"b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10"));
